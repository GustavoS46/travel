...
const Features = () => {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row items-center md:mx-32 gap-14">
      <div className="w-full lg:w-2/4">
        <div className="space-y-4">
          ...
          <p>
            DIscover the Best Holiday Experiences with TriPixie! We're dedicated
        ...
        <div className="flex flex-row gap-5">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[#898888]">
              We will provide excellent and friendle service for the sake of our
              customers.
            </p>
          </div>
        </div>

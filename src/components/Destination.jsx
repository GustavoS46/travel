    ...
    <div className="min-h-screen flex flex-col justify-center md:mx-32 mx-5">
      ...
      <div className="flex flex-col lg:flex-row gap-5 mt-14">
        ...
        <DestinationCard
          img={img2}
          title="Dubai, UAE"
          para="A city of superlatives, Dubai boats towering skyscrapers, luxury shopping, and desert adventures."
        />
        <DestinationCard
          img={img3}
          title="Venice, Italy"
          para="Explore the romantic canals and historic architeture of Venice, a city build on water."
        />
      </div>
    </div>
  );
